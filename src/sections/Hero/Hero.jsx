    ...
    <div className={styles.hero}>
      ...
      >
        <div className={styles.titleWrapper}>
          ...
          >
            Embark on a journey of innovation and discovery with KIIT's premier research initiative. Shape the future through groundbreaking research and global collaborations.
          </motion.p>
        </div>
